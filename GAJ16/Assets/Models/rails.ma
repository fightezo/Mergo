...
//Name: rails.ma
//Last modified: Thu, Apr 21, 2016 07:55:14 PM
//Codeset: 1252
requires maya "2016";
...
createNode transform -s -n "persp";
	rename -uid "0A80FA01-4FED-E912-213F-23B858AFFCF6";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.4927061147465395 3.3908835594735081 9.0988105057231436 ;
	setAttr ".r" -type "double3" -15.33835272409611 380.99999999998147 -4.2585440300475472e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1BE0CEAB-4C03-7678-F8BA-6BAC29B7FC88";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 10.106119531536656;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 0.71762648940686335 0 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "2E9D4009-4374-3256-999E-048AC410EFBF";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 100.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "01787CD2-4397-723F-55F6-6DAC7ED9D0D4";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "56DE82D7-4F00-F29E-C0A6-D8A1A6C87C5B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 100.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "F35CC0EA-4571-99C4-89A9-CB9CBAC48854";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "FDFA3D67-4EC9-E3B8-780A-E383CCD50D99";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1273243380202 2.5799566253921506 -2.796163538158495e-008 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "D49693CA-4535-8867-3584-0EB5DA3614E3";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
...
createNode transform -n "pCylinder1";
	rename -uid "618F29B5-47AA-6B25-E502-9EB46ABBAEAB";
	setAttr ".t" -type "double3" 0 2.7497568262609509 0 ;
	setAttr ".r" -type "double3" 0 0 90 ;
	setAttr ".s" -type "double3" 0.15637292316733659 2.5429368365367688 0.15637292316733659 ;
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	rename -uid "68F101D6-4B5A-DA3A-E1B8-7EBC4716CE3B";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "pPlane1";
	rename -uid "3163A54A-4381-B4C7-9F93-10ACCAD0141B";
	setAttr ".t" -type "double3" 0 0.81050574637280703 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
	setAttr ".s" -type "double3" 5.0325356056181194 1 3.2865968233025038 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "10A01193-40E7-108C-5A28-61B57727D451";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pPlane2";
	rename -uid "54B1FA68-40B6-124E-E66C-69BAB63CBFD4";
	setAttr ".t" -type "double3" 0 0.81050574637280703 0.0062193504208294392 ;
	setAttr ".r" -type "double3" -90 180 0 ;
	setAttr ".s" -type "double3" 5.0325356056181194 1 3.2865968233025038 ;
createNode mesh -n "pPlaneShape2" -p "pPlane2";
	rename -uid "5E9C3E55-420E-6181-45B3-639ED92AF15D";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4BF3243B-43EA-2D85-7168-C39E709BFDF3";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "A6BB925F-4C64-7DD4-F25A-789D74BE06B7";
createNode displayLayer -n "defaultLayer";
	rename -uid "6FAA5373-4BC8-D6E8-EA3C-4E81059B7091";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "51AECAFA-4575-627F-5395-DF8AD704A523";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "BA7F61D1-4FB7-F8F0-F6F2-4BABFF466954";
	setAttr ".g" yes;
createNode polyCylinder -n "polyCylinder1";
	rename -uid "D69542E0-49F3-6A06-53C0-1FB5AA0F22B4";
	setAttr ".sc" 1;
	setAttr ".cuv" 3;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "ECB47CFC-4367-B84D-C3BC-A08F549068D7";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "9D5057AE-43F0-4BC2-5040-7A89DCF8D383";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 120 -ast 1 -aet 200 ";
	setAttr ".st" 6;
createNode polyPlane -n "polyPlane1";
	rename -uid "F5550F7E-427E-7FA4-6430-A794176473BA";
	setAttr ".cuv" 2;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
